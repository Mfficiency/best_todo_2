...
/// First-launch chooser between the two ways to run the app: *simple mode*
/// (the plain task list, nothing else) and *full mode* (every tool and extra).
/// Shown after the intro until [Config.modeChosen] is true; the choice can be
/// changed later under Settings → Mode & features.
