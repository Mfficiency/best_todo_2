...
/// Bumps the version in pubspec.yaml and prepends a dated entry to CHANGELOG.md.
/// The app never hard-codes a version, so this file + pubspec are the single
/// source of truth.
///
/// Usage:
///   dart run tool/bump_version.dart <version>[+build] ["changelog entry"]
void main(List<String> args) {
  ...
  final bodyStart = lines.isNotEmpty && lines.first.trim() == header ? 1 : 0;
